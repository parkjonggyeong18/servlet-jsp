        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="/index.do" class="nav-link px-2 text-white">NHN쇼핑</a></li>
                    <a class="btn btn-outline-light me-2" href="/mypage/mypage.do" >마이페이지</a>
                    <a class="btn btn-outline-light me-2" href="/mypage/cart.do" >쇼핑카트</a>
                </ul>
